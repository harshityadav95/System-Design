...
Subset Sum Problem: [https://en.wikipedia.org/wiki/Subset\_sum\_problem](https://en.wikipedia.org/wiki/Subset_sum_problem)
...
{% embed url="https://youtu.be/xxtKnynf9\_I" %}
