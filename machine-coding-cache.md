...
Cache Write Policies: [https://en.wikipedia.org/wiki/Cache\_\(computing\)\#Writing\_policies](https://en.wikipedia.org/wiki/Cache_%28computing%29#Writing_policies) 

An in depth explanation of ordering and read/write guarantees.

Cache replacement policies of LRU and LFU: [https://en.wikipedia.org/wiki/Cache\_replacement\_policies](https://en.wikipedia.org/wiki/Cache_replacement_policies)
